...
router.get('/', function (req, res) {
  res.render('index', { title: 'moutain App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'moutain App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'moutain App Login', user: req.user });
});
